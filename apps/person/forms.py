...
from django.contrib.auth.forms import UserChangeForm as _UserChangeForm, UserCreationForm
...
class UserChangeForm(_UserChangeForm):
    ...
    fieldsets = [
            ...
            ('User settings', {
                'classes': ('collapse',),
                'fields': ['username', 'email', 'password', 'groups', 'date_joined', 'is_staff', 'last_login']}),
            ]
